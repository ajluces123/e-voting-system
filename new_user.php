				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<input type="text" name="section" class="form-control form-control-sm" required value="<?php echo isset($section) ? $section : '' ?>">						
						</div>
					</div>
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select custom-select-sm">
								<option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Voter</option>
